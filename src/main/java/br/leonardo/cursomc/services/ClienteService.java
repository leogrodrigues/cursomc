...
import br.leonardo.cursomc.dto.ClienteDTO;
...
import br.leonardo.cursomc.services.exceptions.DataIntegrityException;
...
public class ClienteService {
	...
	public void delete(Integer id) {
		...
		try {
			...
			throw new DataIntegrityException("Não é possivel excluir um cliente com pedido ativo");
		}
	}
	...
	//a partir de um obj DTO cria uma Cliente
