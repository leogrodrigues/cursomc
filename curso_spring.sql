...
--
-- Host: 127.0.0.1
-- Generation Time: 29-Ago-2018 às 16:36
...
(2, 'Centro', '38777012', 'Sala 800', 'Avenida Matos', '105', 1, 1);
...
INSERT INTO `pedido` (`id`, `instance`, `cliente_id`, `endereco_de_entrega_id`) VALUES
...
INSERT INTO `produto_categoria` (`protudo_id`, `categoria_id`) VALUES
(1, 1),
(1, 4),
(2, 1),
(2, 2),
...
ALTER TABLE `produto_categoria`
  ...
  ADD KEY `FKg3xu72kopttrib0t26s1yfvqk` (`protudo_id`);
